...
public class LocalNotification extends GodotPlugin {
    ...
    */
    ...
    @UsedByGodot
    public void showLocalNotification(String message, String title, int interval, int tag, String smallIconName, String LargeIconName, String summaryText, String colorImage) {
        if(interval <= 0) return;
        Log.d(TAG, "showLocalNotification: "+message+", "+Integer.toString(interval)+", "+Integer.toString(tag));
        PendingIntent sender = getPendingIntent(message, title, tag, smallIconName, LargeIconName, summaryText, colorImage);
    ...
    @UsedByGodot
    public void showRepeatingNotification(String message, String title, int interval, int tag, int repeat_duration, String smallIconName, String LargeIconName, String summaryText, String colorImage) {
        if(interval <= 0) return;
    ...
    private PendingIntent getPendingIntent(String message, String title, int tag, String smallIconName, String LargeIconName, String summaryText, String colorImage) {
        ...
        i.putExtra("smallIconName", smallIconName);
        i.putExtra("LargeIconName", LargeIconName);
        i.putExtra("textOfSummary", summaryText);
        i.putExtra("colorOfIcon", colorImage);
